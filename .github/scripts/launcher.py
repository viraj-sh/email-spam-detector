...
if not args.debug:
    ...
    os.environ["EMAIL_SPAM_DETECTOR_QUIET"] = "1"
...
if __name__ == "__main__":
    ...
    if args.debug:
        print(
            f"""{BOLD}{FG_RED}🚀 Starting backend{RESET}
...
{FG_WHITE}• Mode:{RESET} {BOLD}QUIET{RESET}"""
    ...
    if wait_for_server(port):
        ...
        print(
            f"""
{BOLD}{FG_GREEN}✅ Backend is ready{RESET}
...
{FG_RED}Note:{RESET} Keep this window open; closing it stops the backend."""
        )
...
• Try: email-spam-detector.exe --debug
